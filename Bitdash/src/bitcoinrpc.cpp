...
{
    return GetBoolArg("-testnet", false) ? 12332 : 4444;
}
...
int64 AmountFromValue(const Value& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 8200000000.00000000)
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "bitdash server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: bitdash-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use bitdashd";
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("%s, you must set a rpcpassword in the configuration file:\n"
              ...
              "for example: alertnotify=echo %%s | mail -s \"bitdash Alert\" admin@foo.com\n"),
                strWhatAmI.c_str(),
