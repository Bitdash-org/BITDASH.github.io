...
uint256 hashGenesisBlock("0x4533a30993b62a0c710dda9d9a78d343a2828e138b3330a97bc5052f89a65c80");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(503522264); // bitdash: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "bitdash Signed Message:\n";
...
{
    // bitdash: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 820000); // bitdash: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 256000; // bitdash: 3.5 days
static const int64 nTargetSpacing = 600; // bitdash: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // bitdash: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // bitdash: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // bitdash: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0aa5646b27e40c00422145f2720016b6c77e3f4ef25a55e0bc6866cda890b939");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Bitdash Coin Cryptocurrency!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("c224e002e63e8690b39b0266e55b99314fb4453821dc8cb3f683210afa64380864c4efe2bc19d74389aee4bd8e762c220d45f9b27c0041138b095df1b02bdc514d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1644748826;
        block.nBits    = 503522264;
        block.nNonce   = 283187946;

        if (fTestNet)
        {
            block.nTime    = 1644748826;
            block.nNonce   = 349931193;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x895b0c7161a05afe6a549fca822554d633c9e24bb559f5d1ea15fcfc11a67951"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // bitdash: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("bitdashMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("bitdashMiner : ProcessBlock, block not accepted");
    }
